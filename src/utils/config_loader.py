...
ALL_SETTINGS = [
    # ABS
    'ABS_ENABLED', 'ABS_SERVER', 'ABS_WEB_URL', 'ABS_KEY', 'ABS_LIBRARY_IDS',
    ...
    # Storyteller
    'STORYTELLER_ENABLED', 'STORYTELLER_API_URL', 'STORYTELLER_WEB_URL', 'STORYTELLER_USER', 'STORYTELLER_PASSWORD',
    'STORYTELLER_ASSETS_DIR',

    # Booklore
    'BOOKLORE_ENABLED', 'BOOKLORE_LABEL', 'BOOKLORE_SERVER', 'BOOKLORE_WEB_URL', 'BOOKLORE_USER', 'BOOKLORE_PASSWORD', 'BOOKLORE_SHELF_NAME', 'BOOKLORE_LIBRARY_ID',

    # CWA (Calibre-Web Automated)
    'CWA_ENABLED', 'CWA_SERVER', 'CWA_WEB_URL', 'CWA_USERNAME', 'CWA_PASSWORD',

    # Hardcover
    'HARDCOVER_ENABLED', 'HARDCOVER_TOKEN', 'HARDCOVER_WEB_URL',
