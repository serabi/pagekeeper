...
ALL_SETTINGS = [
    # ABS
    'ABS_ENABLED', 'ABS_SERVER', 'ABS_WEB_URL', 'ABS_WEB_URL_INTERNAL', 'ABS_WEB_URL_EXTERNAL',
    'ABS_HEADER_URL_MODE', 'ABS_KEY', 'ABS_LIBRARY_IDS',
    ...
    # Storyteller
    'STORYTELLER_ENABLED', 'STORYTELLER_API_URL', 'STORYTELLER_WEB_URL', 'STORYTELLER_WEB_URL_INTERNAL',
    'STORYTELLER_WEB_URL_EXTERNAL', 'STORYTELLER_HEADER_URL_MODE', 'STORYTELLER_USER', 'STORYTELLER_PASSWORD',
    'STORYTELLER_ASSETS_DIR',

    # Booklore
    'BOOKLORE_ENABLED', 'BOOKLORE_LABEL', 'BOOKLORE_SERVER', 'BOOKLORE_WEB_URL', 'BOOKLORE_WEB_URL_INTERNAL',
    'BOOKLORE_WEB_URL_EXTERNAL', 'BOOKLORE_HEADER_URL_MODE', 'BOOKLORE_USER', 'BOOKLORE_PASSWORD',
    'BOOKLORE_SHELF_NAME', 'BOOKLORE_LIBRARY_ID',

    # CWA (Calibre-Web Automated)
    'CWA_ENABLED', 'CWA_SERVER', 'CWA_WEB_URL', 'CWA_WEB_URL_INTERNAL', 'CWA_WEB_URL_EXTERNAL',
    'CWA_HEADER_URL_MODE', 'CWA_USERNAME', 'CWA_PASSWORD',

    # Hardcover
    'HARDCOVER_ENABLED', 'HARDCOVER_TOKEN', 'HARDCOVER_WEB_URL', 'HARDCOVER_WEB_URL_INTERNAL',
    'HARDCOVER_WEB_URL_EXTERNAL', 'HARDCOVER_HEADER_URL_MODE',
...
DEFAULT_CONFIG = {
    ...
    'HARDCOVER_WEB_URL': '',
    'HARDCOVER_WEB_URL_INTERNAL': '',
    'HARDCOVER_WEB_URL_EXTERNAL': '',
    'HARDCOVER_HEADER_URL_MODE': 'external',
